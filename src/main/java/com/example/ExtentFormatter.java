...
public class ExtentFormatter implements Reporter, Formatter {
    ...
    public static HashMap<String,String> imageStepHashMap = new HashMap<>();
    ...
    public void result(Result result) {
        ...
        String stepName = testSteps.poll().getName();

        if (!scenarioOutlineTest) {
            String appendableValue = ((imageStepHashMap.get(stepName) == null) ? " " : scenarioTest.addScreenCapture(imageStepHashMap.get(stepName)));

            if ("passed".equals(result.getStatus())) {
                scenarioTest.log(LogStatus.PASS, stepName, "PASSED " + appendableValue);
            } else if ("failed".equals(result.getStatus())) {
                scenarioTest.log(LogStatus.FAIL, stepName, result.getError() + " " + appendableValue);
            } else if ("skipped".equals(result.getStatus())) {
                scenarioTest.log(LogStatus.SKIP, stepName, "SKIPPED " + appendableValue);
            } else if ("undefined".equals(result.getStatus())) {
                scenarioTest.log(LogStatus.UNKNOWN, stepName, "UNDEFINED " + appendableValue);
            }
        }
    }
